...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CE1
\pic[shift={(1.2,0,0)}] at (d4-east) {RightBandedBox={name=ce1,caption=CE,%
        xlabel={{"1","dummy"}},zlabel=512,fill=\FcColor,bandfill=\FcReluColor,%
        height=3,width=3,depth=25}};

% CE2
\pic[shift={(3,0,0)}] at (ce1-east) {RightBandedBox={name=ce2,caption=OFC,%
        xlabel={{"1","dummy"}},zlabel=512,fill=\FcColor,bandfill=\FcReluColor,%
        height=3,width=3,depth=25}};

% CE3
\pic[shift={(1,0,0)}] at (ce2-east) {RightBandedBox={name=ce3,caption=,%
