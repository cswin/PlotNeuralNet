...
\def\LAColor{rgb:blue,5;red,0;white,5}
...
\pic[shift={(3,0,0)}] at (fc7-east) {Box={name=d4,%
        xlabel={{"","dummy"}},zlabel=4608,fill=\LAColor,opacity=0.7,height=3,width=3,depth=75}};
%% Dcnv2
...
\pic[shift={(1,0,13+\skipshift)}] at (cr1-west) {Box={name=score2low,%
        fill=\UnpoolColor,opacity=0.6,height=13,width=1,depth=13}};
\pic[shift={(0,0,0)}] at (score2low-east) {RightBandedBox={name=ucr4low,%
        xlabel={{"Attention block","dummy"}},fill=\ConvColor,bandfill=\ConvReluColor,%
...
%% low-road LA-1
\pic[shift={(10,0,0)}] at (ucr4-east) {RightBandedBox={name=la1,caption=fc8,%
        xlabel={{"1","dummy"}},fill=\FcColor,bandfill=\FcReluColor,%
        height=3,width=2,depth=25}};

%% low-road LA-2
\pic[shift={(1,0,0)}] at (la1-east) {RightBandedBox={name=la2,caption=fc9,%
...
%% low-road LA-1
\pic[shift={(10,0,0)}] at (ucr4low-east) {RightBandedBox={name=la1low,caption=fc10,%
        xlabel={{"1","dummy"}},fill=\FcColor,bandfill=\FcReluColor,%
        height=3,width=2,depth=25}};

%% low-road LA-2
\pic[shift={(1,0,0)}] at (la1low-east) {RightBandedBox={name=la2low,caption=fc11,%
        xlabel={{"1","dummy"}},zlabel=512,fill=\FcColor,bandfill=\FcReluColor,%
        height=3,width=2,depth=25}};

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CE1
\pic[shift={(3,0,0)}] at (d4-east) {RightBandedBox={name=ce1,caption=fc12,%
        xlabel={{"1","dummy"}},zlabel=512,fill=\FcColor,bandfill=\FcReluColor,%
        height=3,width=3,depth=25}};

% CE2
\pic[shift={(0.5,0,0)}] at (ce1-east) {RightBandedBox={name=ce2,caption=fc13,%
        xlabel={{"1","dummy"}},zlabel=512,fill=\FcColor,bandfill=\FcReluColor,%
        height=3,width=3,depth=25}};

% CE3
\pic[shift={(0.5,0,0)}] at (ce2-east) {RightBandedBox={name=ce3,caption=fc14,%
...
\draw [connection_lowroad]  (la1low-east)   -- node {\fmidarrow} (la2low-west);

%
\path (cr1-west) coordinate[pos=-0.4] (after2low) ;
...
\draw [connection_lowroad]  (after2low)    -- node {\fmidarrow} ++(0,0,13+\skipshift) -- node {\fmidarrow} (score2low-west);
...
\draw [connection_lowroad]  (ucr4low-east) -- node{\fmidarrow} (la1low-west);
\draw [connection_lowroad]  (la2low-east) -- node{\fmidarrow} (d4h) -- node{\fmidarrow}(d4-near);
%
